...
namespace VelocityMap.VelocityGenerate
{
    class Units
    {
            private static double kInchesPerFoot = 12.0;
            private static double kMetersPerInch = 0.0254;
            private static double kSecondsPerMinute = 60;
            private static double kMillisecondsPerSecond = 1000;
            private static double kKilogramsPerLb = 0.453592;
